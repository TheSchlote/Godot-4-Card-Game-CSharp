...
public partial class Battle : Node2D
{
    ...
    public override void _Ready()
    {
        ...
        //_enemyHandler.Connect("child_order_changed", this, nameof(OnEnemiesChildOrderChanged));
        ...
        events.Connect("PlayerHandDiscarded", new Callable(_playerHandler, nameof(PlayerHandler.StartTurn)));
        //events.Connect("PlayerHandDiscarded", _enemyHandler, nameof(EnemyHandler.StartTurn));
